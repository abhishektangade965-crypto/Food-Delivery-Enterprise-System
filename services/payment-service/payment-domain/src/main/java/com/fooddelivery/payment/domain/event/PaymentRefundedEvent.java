...
public class PaymentRefundedEvent implements DomainEvent<Payment> {
    private final Payment payment;
    private final ZonedDateTime createdAt;
    private final List<String> failureMessages;
    private final String eventId;

    public PaymentRefundedEvent(Payment payment, ZonedDateTime createdAt, List<String> failureMessages) {
