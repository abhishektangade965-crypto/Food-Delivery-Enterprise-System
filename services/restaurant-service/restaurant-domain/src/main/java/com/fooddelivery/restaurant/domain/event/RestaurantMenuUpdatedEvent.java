...
public class RestaurantMenuUpdatedEvent implements DomainEvent<Restaurant> {
    private final Restaurant restaurant;
    private final ZonedDateTime createdAt;
    private final String eventId;

    public RestaurantMenuUpdatedEvent(Restaurant restaurant, ZonedDateTime createdAt) {
